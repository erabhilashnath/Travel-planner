...
export const labelClass = "mb-1 block text-sm font-medium text-zinc-100";
...
export const secondaryButtonClass =
  "flex items-center justify-center rounded-full border border-white/25 px-5 py-2.5 text-sm font-medium text-zinc-100 transition-colors hover:bg-white/10";
